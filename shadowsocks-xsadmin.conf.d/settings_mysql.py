...
ALLOWED_HOSTS = (os.environ.get('ALLOWED_HOST','*') , '172.17.0.1',)
# Database
...
#极验证
GEE_CAPTCHA_ID = os.environ.get('GEE_ID', 'b46d1900d0a894591916ea94ea91bd2c')
GEE_PRIVATE_KEY = os.environ.get('GEE_KEY','36fc3fe98530eea08dfc6ce76e3d24c4')
